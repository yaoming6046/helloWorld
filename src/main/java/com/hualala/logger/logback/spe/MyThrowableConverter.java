...
public class MyThrowableConverter extends ThrowableProxyConverter {

    @Override
    protected void extraData(StringBuilder builder, StackTraceElementProxy step) {
//        super.extraData(builder, step);
        builder.append("\t").append(ThreadHolder.getValue());
    }
    ...
    private void subjoinExceptionMessage(StringBuilder buf, IThrowableProxy tp) {
        buf.append(tp.getClassName()).append(": ").append(tp.getMessage()).append("\t").append(ThreadHolder.getValue());
    }
